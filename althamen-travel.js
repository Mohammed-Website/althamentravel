        ...
        if (messageBar.value.trim() !== "") {
            ...
            let botResponse = `
                <div class="chat response">
                    <img src="https://mohammed-website.github.io/althamentravel/%D9%85%D9%83%D8%AA%D8%A8-%D8%B3%D9%8A%D8%A7%D8%AD%D9%8A/%D9%85%D9%83%D8%AA%D8%A8-%D8%B3%D9%8A%D8%A7%D8%AD%D9%8A-%D8%A8%D8%AD%D8%B1%D9%8A%D9%86%D9%8A.png">
                    <span class="new">...</span>
                </div>
            `;
...
const sectionData = [

    {
        title: 'عروض مشهد',
        main_image_1: {
            mainSrc: 'عروض-شركة-الثامن/عروض-مشهد-1/عرض-مشهد-1.jpg',
            subImages: [
                'عروض-شركة-الثامن/عروض-مشهد-1/عرض-مشهد-1-تفاصيل-1.jpg',
        ...
        main_image_2: {
            mainSrc: 'عروض-شركة-الثامن/عروض-مشهد-2/عرض-مشهد-2.jpg',
            subImages: [
                'عروض-شركة-الثامن/عروض-مشهد-2/عرض-مشهد-2-تفاصيل-1.jpg',
        ...
        main_image_3: {
            mainSrc: 'عروض-شركة-الثامن/عروض-مشهد-3/عرض-مشهد-3.jpg',
            subImages: [
                'عروض-شركة-الثامن/عروض-مشهد-3/عرض-مشهد-3-تفاصيل-1.jpg',
...
function openFullScreenImage(mainSrc, subImages, text) {
    ...
    whatsappButton.href = `https://wa.me/+97366638555?text=طلب%20حجز%20هذا%20العرض:%0A%0Ahttps://mohammed-website.github.io/althamentravel/${encodeURIComponent(mainSrc)}`;
...
let mughader_commentsArray = [
    ...
    },
    {
        ...
        comment: "شكرا شركة الثامن على اتقانكم  بالعمل وعلى خدمتكم الجميله بارك الله فيكم وفي جهودكم الى الاعلى بإذن",
        stars: 5
    },
    {
        profileImage: "https://mughader.com/مكتب-للسفر-والسياحة/مكتب-للسفر-والسياحة-3.png",
        personName: "ناصر الهزاع",
        comment: "اشكر طاقم شركة الثامن على تعاملهم معي يستاهلو كل خير ♥️♥️",
        stars: 5
    },
    {
        profileLetter: "F",
    ...
    },
    {
        ...
        comment: "نشكر شركة الثامن على جهوده وتمنى له دائم التوفيق و والــــنــــجـــــاح",
        stars: 5
    },
    {
        profileLetter: "H",
        personName: "Hala Abdullah",
        comment: "من افضل واحسن الي تعاملت معهم للامانة ولا غلطة والاسعار حلوه جدا ومعقولة مرا شككككرا  شركة الثامن للسياحة 💛🙏🏻",
        stars: 5
    },
    {
        profileLetter: "س",
        personName: "سامي الموسى",
        comment: "صراحه مجهود يشكر عليه من شركة الثامن للسفر والسياحة ومن افضل الشركات الي حريصه علئ ادق التفاصيل شركه تلبي جميع احتيجاتك وعن تجربه اتكلم صراحه تعاملهم جدا راقي بجميع الاماكن والاوقات ❤️❤️",
        stars: 5
    },
];
...
function mughader_generateComments(comments) {
    ...
    comments.forEach(({ profileLetter, profileImage, personName, comment, stars }, index) => {
        ...
        if (profileImage) {
            ...
            img.alt = `مكتب سياحي - شركة الثامن`;
            img.title = `مكتب سياحي - شركة الثامن`;
...
openWhatsAppNumber = function () {
    ...
    const whatsappNumber = "+97366638555";
